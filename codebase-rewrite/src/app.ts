...
import { Builder, WebDriver, Capabilities, Proxy as SeleniumProxyConfig } from 'selenium-webdriver';
...
// import leadRoutes from './routes/lead.routes'; // Commented out
import linkedInAccountRoutes from './routes/linkedInAccount.routes';
// import proxyRoutes from './routes/proxy.routes'; // Commented out
// import leadCommentRoutes from './routes/leadComment.routes'; // Commented out
// import leadLogsRoutes from './routes/leadLogs.routes'; // Commented out
// import leadStatusRoutes from './routes/leadStatus.routes'; // Commented out
// import emailSettingsRoutes from './routes/emailSettings.routes'; // Commented out
...
const createWebDriver = async (proxy?: string): Promise<WebDriver> => {
  ...
  if (proxy) {
    const seleniumProxy: SeleniumProxyConfig = {
        proxyType: 'manual',
        httpProxy: proxy,
        sslProxy: proxy,
...
class App {
  ...
  private configureRoutes(): void {
    ...
    // this.app.use('/lead', leadRoutes); // Commented out
    this.app.use('/linkedInAccount', linkedInAccountRoutes);
    // this.app.use('/proxies', proxyRoutes); // Commented out
    // this.app.use('/leadComments', leadCommentRoutes); // Commented out
    // this.app.use('/leadLogs', leadLogsRoutes); // Commented out
    // this.app.use('/leadStatus', leadStatusRoutes); // Commented out
    // this.app.use('/emailSettings', emailSettingsRoutes); // Commented out
  ...
  private async connectToDatabases(): Promise<void> {
    ...
    try {
        ...
        console.error('Failed to connect to Redis during app initialization:', redisError);
  ...
  private async setupSelenium(): Promise<void> {
    try {
        ...
        console.error('Initial Selenium setup failed. Scraping features might be unavailable.', error);
