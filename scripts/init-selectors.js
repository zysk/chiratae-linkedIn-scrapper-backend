...
const defaultSelectors = {
	...
	'Skills Section': ['section#skills', 'section[data-section="skills"]', 'section.artdeco-card.pv-profile-section.skills-section'],
	...
	'Profile Picture': ['img.pv-top-card-profile-picture__image', 'img.profile-photo-edit__preview', 'div.pv-top-card--photo img'],
	'Company Name': [
		'span.pv-entity__secondary-title',
		'h4.pv-entity__secondary-title',
		'div.inline-show-more-text span[aria-hidden="true"]',
	],
	'Job Title': ['div.pv-entity__summary-info h3', 'div.pv-entity__summary-info-v2 h3', 'span.pv-entity__job-title'],
	'School Name': ['h3.pv-entity__school-name', 'div.pv-entity__degree-info a', 'span.pv-entity__school-name'],
}
