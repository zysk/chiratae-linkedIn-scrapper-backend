...
async function runLinkedInAccountTests() {
	try {
		...
		try {
			const createResponse = await axios.post(`${baseUrl}/linkedin-accounts`, linkedinAccount, {
		...
		const getAllResponse = await axios.get(`${baseUrl}/linkedin-accounts`, { headers: { Authorization: `Bearer ${adminToken}` } })
		...
		try {
			const getByIdResponse = await axios.get(`${baseUrl}/linkedin-accounts/${linkedinAccountId}`, {
				headers: { Authorization: `Bearer ${adminToken}` },
			})
		...
		const updateResponse = await axios.put(`${baseUrl}/linkedin-accounts/${linkedinAccountId}`, updatedLinkedinAccount, {
			headers: { Authorization: `Bearer ${adminToken}` },
		})
		...
		try {
			const nextResponse = await axios.get(`${baseUrl}/linkedin-accounts/next/available`, {
				headers: { Authorization: `Bearer ${adminToken}` },
			})
...
async function runProxyTests() {
	try {
		...
		try {
			const createResponse = await axios.post(`${baseUrl}/proxies`, proxy, { headers: { Authorization: `Bearer ${adminToken}` } })
		...
		const getAllResponse = await axios.get(`${baseUrl}/proxies`, { headers: { Authorization: `Bearer ${adminToken}` } })
		...
		try {
			const getByIdResponse = await axios.get(`${baseUrl}/proxies/${proxyId}`, { headers: { Authorization: `Bearer ${adminToken}` } })
		...
		const updateResponse = await axios.put(`${baseUrl}/proxies/${proxyId}`, updatedProxy, {
			headers: { Authorization: `Bearer ${adminToken}` },
		})
		...
		try {
			const nextResponse = await axios.get(`${baseUrl}/proxies/next/available`, {
				headers: { Authorization: `Bearer ${adminToken}` },
			})
...
async function cleanup() {
	try {
		...
		if (linkedinAccountId) {
			...
			const deleteAccountResponse = await axios.delete(`${baseUrl}/linkedin-accounts/${linkedinAccountId}`, {
				headers: { Authorization: `Bearer ${adminToken}` },
			})
		...
		if (proxyId) {
			...
			const deleteProxyResponse = await axios.delete(`${baseUrl}/proxies/${proxyId}`, {
				headers: { Authorization: `Bearer ${adminToken}` },
			})
